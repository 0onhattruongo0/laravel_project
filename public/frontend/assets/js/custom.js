...
$(document).ready(function () {
  ...
  const videoTrials = {};
  $('[id^="trial_learn_"]').on('hidden.bs.modal', () => {
    const linkVideo =  $(this).find('iframe').attr('src');
    videoTrials[$(this).attr('id')] = linkVideo;
    $(this).find('iframe').attr('src', '');
  })

  $('[id^="trial_learn_"]').on('shown.bs.modal', () => {
    $(this).find('iframe').attr('src', videoTrials[$(this).attr('id')]);
  })

  $(".notifications li a").on("click", function (e) {
  ...
  let notifyCount = $(".notifications li a").length;

  if (localStorage.getItem("notifications")) {
    const notifications = JSON.parse(localStorage.getItem("notifications"));
    $(".notifications li a").each(function () {
      const id = $(this).data("id");
  ...
  $(".notifications .badge").text(notifyCount);
});
